...
Class Pdo_handler{
    ...
    public function create($bodem,$saus,$pizzatoppings,$kruiden){
        try{
            $sql = $this->conn->prepare("INSERT INTO pizza (bodem, saus, toppings, kruiden)
            VALUES (:bodem, :saus, :toppings, :kruiden)");

            $sql->bindParam(':bodem', $bodem);
            $sql->bindParam(':saus', $saus);
            $sql->bindParam(':toppings', $pizzatoppings);
    ...
    public function update(){
        try{
            $bodem = $this->sanitize($_POST["bodem"]);
            $saus = $this->sanitize($_POST["saus"]);
            $pizzatoppings = $this->sanitize($_POST["pizzatoppings"]);
            ...
            $sql = $this->conn->prepare("UPDATE `pizza` SET `bodem`=:bodem,`saus`=:saus,`toppings`=:toppings,`kruiden`=:kruiden WHERE `pizza`.`id`= $id;");
